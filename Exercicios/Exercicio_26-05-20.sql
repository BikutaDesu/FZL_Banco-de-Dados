...
('Fulano',  'da Silva', 'R. Volunt�rios da Patria',    8150,   'Santana',  '05423110', '76895248', '05-15-1974',   4350.00),
...
('Tirano',  'De Souza', 'Avenida �guia de Haia', 4430, 'Artur Alvim',  '05448000', NULL,   NULL,   '10-15-1975',   2804.00)
...
(SELECT codigo FROM projeto WHERE nome = 'Modifica��o do m�dulo de cadastro'))
